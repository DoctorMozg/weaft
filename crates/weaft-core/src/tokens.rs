...
static CL100K: LazyLock<CoreBPE> = LazyLock::new(|| cl100k_base().expect("cl100k_base BPE table"));
static O200K: LazyLock<CoreBPE> = LazyLock::new(|| o200k_base().expect("o200k_base BPE table"));
